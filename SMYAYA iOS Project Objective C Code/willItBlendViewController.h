//
//  willItBlendViewController.h
//  testing 2
//
//  Created by Christopher Dollinger on 6/26/13.
...
@interface willItBlendViewController : UITableViewController
{
    UITableView *blendIt;
}

@property (strong, nonatomic) IBOutlet UITableView *blendIt;
