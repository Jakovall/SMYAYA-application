...
@interface UserProfileSettings : UITableViewController <UITableViewDelegate, UITableViewDataSource>
{
    UITableView *Profileselect;
}
@property (strong, nonatomic) IBOutlet UITableView *ProfileSelect;
