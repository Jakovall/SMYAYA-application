...
#import "CustomisDetailView.h"

@interface CustomisDetailView ()

@end

@implementation CustomisDetailView
...
{
    NSString *welcomeHome = [[NSUserDefaults standardUserDefaults] valueForKey:@"SelectedContent"];
    contentOutlet.text = welcomeHome;
}
